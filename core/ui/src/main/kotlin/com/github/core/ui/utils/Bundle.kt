...
private inline fun <T> Bundle.bundleDelegate(
    ...
    // We capture 'this' here to permanently fix the 'this@Bundle unresolved label' error
    val currentBundle = this
...
class EqualizerIntentBundleAccessor(val extras: Bundle = Bundle()) : BundleAccessor {
    companion object {
        ...
        context(ctx: Context)
        fun sendCloseEqualizer(sessionId: Int) = ctx.sendBroadcast(
